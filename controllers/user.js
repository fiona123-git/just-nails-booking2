...
// we use asynce handler to handle exceptions inside of async express routes and passing them to your express error handlers.
//authorise user
const authUser = asyncHandler(async (req, res) => {
  const { email, password } = req.body // body data
// 
